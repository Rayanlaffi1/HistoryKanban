...
import DetailTache from "@/composants/kanban/DetailTache.vue"
import SousTachesTache from "@/composants/kanban/SousTachesTache.vue"
  ...
  >
    ...
    <div v-show="!tache || onglet === 'detail'">
      ...
      <div v-else class="space-y-4">
        ...
        <SectionFormulaire v-if="tache" titre="Sous-tâches">
          <SousTachesTache :tache="tache" :projet="projet" :edition="true" />
        </SectionFormulaire>
